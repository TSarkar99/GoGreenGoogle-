...
public class week1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new ValueDataEntry("Week: 1", avg1));
        data.add(new ValueDataEntry("Week: 2", avg2));
        data.add(new ValueDataEntry("Week: 3", avg3));
        data.add(new ValueDataEntry("Week: 4", avg4));
